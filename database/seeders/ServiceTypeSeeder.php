    ...
    public function run(): void
    {
        ...
        foreach ($branches as $branch) {
            foreach ($serviceTypes as $type) {
                $slug = \Illuminate\Support\Str::slug($type['name']) . '-' . $branch->id;
        ...
        $this->command->info('Created ' . (count($serviceTypes) * $branches->count()) . ' service types for ' . $branches->count() . ' branch(es).');
    }
}
